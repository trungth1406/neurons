/*!
 * d3-force standalone bundle, vendored for the neurons interactive HTML export.
 * Concatenated unmodified UMD minified dist builds, in dependency order, each
 * attaching to the shared window.d3 namespace:
 ...
 * Fetched via `npm pack` from the npm registry.
 *
